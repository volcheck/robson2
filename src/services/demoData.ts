...
export const demoBirthRecords: BirthRecord[] = [
  ...
  },
  {
    ...
    discharge_date: '', robson_code: 5, is_cesarean: true,
  ...
  },
  {
    ...
    discharge_date: '', robson_code: 2, is_cesarean: true,
  ...
  },
  {
    ...
    discharge_date: fmt(yesterday), robson_code: 4, is_cesarean: false,
